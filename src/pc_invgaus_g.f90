subroutine pc_invgaus_g(linkid,n,p,X,y,nup,w,b,phi,ru,dev,A,nv,nav,nnonzero,g_seq,mthd,g0,g_hat,dg_max,eps,np,ncrct,cf,&
NReps,nNR,conv)
...
X2 = X*X
nstp = 1
call w_mk_invgaus_g(linkid,n,p,mi,X,X2,w,conv)
if(conv.eq.5) then
    np=nstp
    return
end if
...
if(nup.ne.0) then
    ...
    ba=0.d0
    ba(0)=b(0,nstp)
    call bastart_invgaus_g(linkid,n,nup,X(:,A(1:nup)),X2(:,A(1:nup)),y,mi,NReps,nNR,ba,conv)
    if(conv.eq.0) then
        b(0,nstp)=ba(0)
...
do k=2,np
    ...
    call prd_invgaus_g(linkid,mthd,g,g0,n,p,X,X2,y,A,nav,nup,ba,mi,eta,mu,dth_de,dmu_de,dmu_dth,sqrt_ib,&
    ...
    do nsbstp=1,ncrct
        call crct_invgaus_g(linkid,n,nav,X(:,A(1:nav)),X2(:,A(1:nav)),y,nup,ba,dba,g,dg,w(A(1:nav)),ruv_old(A(1:nav)),&
...
np = nstp
end subroutine pc_invgaus_g
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
subroutine w_mk_invgaus_g(linkid,n,p,mi,X,X2,w,check)
...
end subroutine w_mk_invgaus_g
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
! Subroutines used in the starting step
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
subroutine bastart_invgaus_g(linkid,n,nav,Xa,X2a,y,mi,NReps,n_step,ba,conv)
...
end subroutine bastart_invgaus_g
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
! Subroutines used in the prediction step
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
subroutine prd_invgaus_g(linkid,mthd,g,g0,n,p,X,X2,y,A,nav,nup,ba,mi,eta,mu,dth_de,dmu_de,dmu_dth,sqrt_ib,w,ruv,&
...
call d2th_dmu2_mk_invgaus(n,mu,d2th_dmu2)
...
end subroutine prd_invgaus_g
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
! Subroutines used in the corrector step
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
subroutine crct_invgaus_g(linkid,n,nav,Xa,X2a,y,nup,ba,dba,g,dg,wa,rua,NReps,nNR,mi,eta,mu,dth_de,dmu_de,ba_crct,conv)
...
ba_prd = ba - dg * dba
call newt_invgaus_g(linkid,n,nav,va,Xa,X2a,y,nup,wa,NReps,nNR,mi,eta,mu,dth_de,dmu_de,ba_prd,conv)
if(conv.ne.0) return
ba_crct = ba_prd
end subroutine crct_invgaus_g
!
subroutine newt_invgaus_g(linkid,n,nav,va,Xa,X2a,y,nup,wa,NReps,n_step,mi,eta,mu,dth_de,dmu_de,ba_crct,conv)
