subroutine pc_pois_c(n,p,X,y,nup,w,b,phi,ru,dev,A,nv,nav,nnonzero,g_seq,mthd,g0,g_hat,dg_max,eps,np,ncrct,cf,NReps,nNR,conv)
...
double precision :: dg,dg_tmp1,dg_tmp2,g,eta(n),mu(n),ruv_old(p),ruv_new(p),dmu_dth(n),sqrt_ib(p),X2(n,p)
...
if(nup.ne.0) then
    ...
    ba=0.
    ba(0)=b(0,nstp)
    call bastart_pois_c(n,nup,X(:,A(1:nup)),X2(:,A(1:nup)),y,NReps,nNR,ba,conv)
    if(conv.eq.0) then
        b(0,nstp)=ba(0)
...
do k=2,np
    ...
    call prd_pois_c(mthd,g,g0,n,p,X,X2,A,nav,nup,ba,mu,dmu_dth,sqrt_ib,w(1:p),ruv_old,dg_max,dba,dg,conv,ai,final)
    if(conv.ne.0) then
        np=nstp
        return
    end if
    do nsbstp=1,ncrct
        call crct_pois_c(n,nav,X(:,A(1:nav)),X2(:,A(1:nav)),y,nup,ba,dba,g,dg,w(A(1:nav)),ruv_old(A(1:nav)),&
...
np = nstp
end subroutine pc_pois_c
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
! Subroutines used in the starting step
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
subroutine bastart_pois_c(n,nav,Xa,X2a,y,NReps,n_step,ba,conv)
...
end subroutine bastart_pois_c
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
! Subroutines used in the prediction step
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
subroutine prd_pois_c(mthd,g,g0,n,p,X,X2,A,nav,nup,ba,mu,dmu_dth,sqrt_ib,w,ruv,dg_max,dba,dg,conv,ai,final)
...
call d2mu_dth2_mk_pois(n,mu,d2mu_dth2)
...
end subroutine prd_pois_c
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
! Subroutines used in the corrector step
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
subroutine crct_pois_c(n,nav,Xa,X2a,y,nup,ba,dba,g,dg,wa,rua,NReps,nNR,mu,dmu_dth,ba_crct,conv)
...
ba_prd = ba - dg * dba
call newt_pois_c(n,nav,va,Xa,X2a,y,nup,wa,NReps,nNR,mu,dmu_dth,ba_prd,conv)
if(conv.ne.0) return
ba_crct = ba_prd
end subroutine crct_pois_c
!
subroutine newt_pois_c(n,nav,va,Xa,X2a,y,nup,wa,NReps,n_step,mu,dmu_dth,ba_crct,conv)
...
end subroutine newt_pois_c
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
! Subroutines related to the poisson family
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
subroutine mu_mk_pois(n,eta,mu)
integer :: i,n
double precision :: eta(n),mu(n)
double precision, parameter :: eps=2.d0**(-52)
forall(i=1:n) mu(i)=max(exp(eta(i)),eps)
end subroutine mu_mk_pois
!
subroutine dmu_dth_mk_pois(n,mu,dmu_dth)
integer :: n
double precision :: mu(n),dmu_dth(n)
dmu_dth=mu
end subroutine dmu_dth_mk_pois
!
subroutine d2mu_dth2_mk_pois(n,mu,d2mu_dth2)
integer :: n
double precision :: mu(n),d2mu_dth2(n)
d2mu_dth2=mu
end subroutine d2mu_dth2_mk_pois
!
subroutine d2th_dmu2_mk_pois(n,mu,d2th_dmu2)
integer :: n
double precision :: mu(n),d2th_dmu2(n)
d2th_dmu2=-1.d0/mu**2
end subroutine  d2th_dmu2_mk_pois
!
subroutine deviance_pois(n,y,mu,dev)
integer :: n
double precision :: y(n),mu(n),dev
dev=2.d0*(sum(y*log(y/mu),mask=y>0.d0)-sum(y-mu))
end subroutine deviance_pois
!
subroutine w_mk_pois_c(n,p,X,X2,w)
integer :: n,p,i
